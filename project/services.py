...
class ASRTextService:
    ...
    def __init__(self):
        ...
        print("🚀 Loading Text Emotion model on", self.device)
    ...
    def run(self, audio_path: str):
        ...
        # ---------- Text Emotion ----------
        inputs = self.tokenizer(transcript, return_tensors="pt").to(self.device)
        with torch.no_grad():
...
class AudioEmotionService:
    ...
    def __init__(self):
        ...
        print("🚀 Loading AST + SER models on", self.device)
